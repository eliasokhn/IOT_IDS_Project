...
save_metrics(test_m, "../reports/metrics_gb_binary.json")
plot_confusion_matrix(
    test_m["confusion_matrix"], test_m["confusion_matrix_labels"],
    title="GB — Binary — Confusion Matrix (Test Set)",
    save_path="../reports/cm_gb_binary.png", normalize=True,
)
...
save_metrics(test_m, "../reports/metrics_gb_8class.json")
plot_confusion_matrix(
    test_m["confusion_matrix"], test_m["confusion_matrix_labels"],
    title="GB — 8-class — Confusion Matrix (Test Set)",
    save_path="../reports/cm_gb_8class.png", normalize=True,
)
plot_per_class_recall(test_m["per_class"],
    title="GB — 8-class — Per-Class Recall",
    save_path="../reports/recall_gb_8class.png")
...
save_metrics(test_m, "../reports/metrics_gb_34class.json")
plot_confusion_matrix(
    test_m["confusion_matrix"], test_m["confusion_matrix_labels"],
    title="GB — 34-class — Confusion Matrix (Test Set)",
    save_path="../reports/cm_gb_34class.png", normalize=True, figsize=(16,14),
)
plot_per_class_recall(test_m["per_class"],
    title="GB — 34-class — Per-Class Recall",
    save_path="../reports/recall_gb_34class.png", figsize=(20, 5))
